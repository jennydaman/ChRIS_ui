 ...
 * 
 * @export
 * @interface DefaultPipingIntParameter
 */
export interface DefaultPipingIntParameter {
    /**
     * 
     * @type {string}
     * @memberof DefaultPipingIntParameter
     */
    readonly url: string;
    /**
     * 
...
/**
 * Check if a given object implements the DefaultPipingIntParameter interface.
 */
export function instanceOfDefaultPipingIntParameter(value: object): value is DefaultPipingIntParameter {
...
export function DefaultPipingIntParameterFromJSON(json: any): DefaultPipingIntParameter {
    return DefaultPipingIntParameterFromJSONTyped(json, false);
}

export function DefaultPipingIntParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefaultPipingIntParameter {
    if (json == null) {
        return json;
    }
    return {
...
export function DefaultPipingIntParameterToJSON(value?: Omit<DefaultPipingIntParameter, 'url'|'id'|'type'|'plugin_piping_id'|'plugin_piping_title'|'previous_plugin_piping_id'|'param_name'|'param_id'|'plugin_piping'|'plugin_name'|'plugin_version'|'plugin_id'|'plugin_param'> | null): any {
    if (value == null) {
        return value;
    }
    return {
