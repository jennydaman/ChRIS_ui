...
/**
 * Check if a given object implements the StrParameter interface.
 */
export function instanceOfStrParameter(value: object): value is StrParameter {
...
export function StrParameterFromJSON(json: any): StrParameter {
    return StrParameterFromJSONTyped(json, false);
}

export function StrParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): StrParameter {
    if (json == null) {
        return json;
    }
    return {
...
export function StrParameterToJSON(value?: Omit<StrParameter, 'url'|'id'|'param_name'|'type'|'plugin_inst'|'plugin_param'> | null): any {
    if (value == null) {
        return value;
    }
    return {
