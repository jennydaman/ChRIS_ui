...
/**
 * Check if a given object implements the IntParameter interface.
 */
export function instanceOfIntParameter(value: object): value is IntParameter {
...
export function IntParameterFromJSON(json: any): IntParameter {
    return IntParameterFromJSONTyped(json, false);
}

export function IntParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): IntParameter {
    if (json == null) {
        return json;
    }
    return {
...
export function IntParameterToJSON(value?: Omit<IntParameter, 'url'|'id'|'param_name'|'type'|'plugin_inst'|'plugin_param'> | null): any {
    if (value == null) {
        return value;
    }
    return {
