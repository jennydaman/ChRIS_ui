 ...
 * 
 * @export
 * @interface DefaultPipingBoolParameter
 */
export interface DefaultPipingBoolParameter {
    /**
     * 
     * @type {string}
     * @memberof DefaultPipingBoolParameter
     */
    readonly url: string;
    /**
     * 
...
/**
 * Check if a given object implements the DefaultPipingBoolParameter interface.
 */
export function instanceOfDefaultPipingBoolParameter(value: object): value is DefaultPipingBoolParameter {
...
export function DefaultPipingBoolParameterFromJSON(json: any): DefaultPipingBoolParameter {
    return DefaultPipingBoolParameterFromJSONTyped(json, false);
}

export function DefaultPipingBoolParameterFromJSONTyped(json: any, ignoreDiscriminator: boolean): DefaultPipingBoolParameter {
    if (json == null) {
        return json;
    }
    return {
...
export function DefaultPipingBoolParameterToJSON(value?: Omit<DefaultPipingBoolParameter, 'url'|'id'|'type'|'plugin_piping_id'|'plugin_piping_title'|'previous_plugin_piping_id'|'param_name'|'param_id'|'plugin_piping'|'plugin_name'|'plugin_version'|'plugin_id'|'plugin_param'> | null): any {
    if (value == null) {
        return value;
    }
    return {
